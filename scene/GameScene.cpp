...
void GameScene::Initialize() {
	...
	//脊椎
	worldTransform_[PartId::Spine].translation_ = {0, 4.0f, 0};//ローカル座標設定
	worldTransform_[PartId::Spine].parent_ = &worldTransform_[PartId::Root];//親指定
	worldTransform_[PartId::Spine].Initialize();//初期化

	//上半身
	worldTransform_[PartId::Chest].translation_ = {0, 5.0f, 0};
